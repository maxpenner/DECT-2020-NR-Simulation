classdef rf_channel < handle
    ...
    properties
        ...
        %
        % This channel type is called deterministic because STO, CFO and error phase have fixed, known values.
        % The white gaussian noise added after applying STO, CFO and error phase it not deterministic.
        % If d_sto = d_cfo = d_err_phase = 0, this channel type becomes AWGN.
    ...
    methods (Static = true, Access = public)
       ...
       % just init parameters outside of constructor, otherwise the constructor has to many arguments
    ...
    methods (Static = false, Access = public)
        ...
        % after setting the members with prefix r_, this function must be called to init Matlab's comm.MIMOChannel
        function init_rayleigh_rician_channel(obj)
            ...
            if strcmp(obj.type,'rayleigh') == false && strcmp(obj.type,'rician') == false
                if strcmp(obj.type,'deterministic')
                    ...
                    error('Unknown channel type %s. Must be rayleigh, rician or deterministic.', obj.type);
                end              
            end
